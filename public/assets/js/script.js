...
// defect in modal
function showDefectInModal() {
    $("#defect-in-modal").modal("show");
}

function hideDefectInModal() {
    $("#defect-in-modal").modal("hide");
}

// defect out modal
function showDefectOutModal() {
    $("#defect-out-modal").modal("show");
}

function hideDefectOutModal() {
    $("#defect-out-modal").modal("hide");
}
